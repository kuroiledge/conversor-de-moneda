...
public class ConvertirMoneda {
    ...
    public static void convertir (String monedaBase, String monedaTarget, ConsultarMoneda consulta, Scanner lectura) {
        ...
        System.out.println("Ingrese la cantidad de " + monedaBase + " que desea convertir a " + monedaTarget);
    ...
    public static void convertirOtraMoneda(ConsultarMoneda consulta, Scanner lectura) {
        System.out.println("Ingrese la moneda base (por sus siglas): ");
        String monedaBase = lectura.nextLine().toUpperCase();

        System.out.println("Ingrese la moneda objetivo (por sus siglas): ");
